    ...
    },
    {
        ...
        "function": {
            ...
            "description": (
                ...
                "먹을 곳은 종류대로 고른다. 한식집·밥집은 '한식', 중국집은 '중식', 초밥·돈까스는 '일식', "
                "스테이크·파스타는 '양식', 빵·베이커리는 '빵집', 피자·햄버거는 '피자햄버거', 치킨은 '치킨', "
                "김밥·분식은 '분식', 술집·펍은 '주점', 막걸리·민속주점은 '전통주점', 카페·찻집·디저트는 '카페', "
                ...
                "properties": {
                    ...
                    "category": {
                        ...
                        "enum": [
                            ...
                            "축제공연행사", "쇼핑", "음식", "한식", "외국식", "중식", "일식",
                            "양식", "간이음식", "빵집", "피자햄버거", "치킨", "분식", "주점",
                            "전통주점", "카페", "숙박", "캠핑", "웰니스", "관광지", "여행코스",
                        ],
                    },
