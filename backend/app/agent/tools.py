    ...
    },
    {
        ...
        "function": {
            ...
            "description": (
                ...
                "먹을 곳은 종류대로 고른다. 한식집·밥집·한정식은 '한식', 양식·일식·중식은 '외국식', "
                "분식은 '간이음식', 술집은 '주점', 카페·찻집·디저트는 '카페', 종류 없이 맛집·식당·"
                "배고프다고만 하면 '음식'. '카페 말고 한식' 처럼 빼 달라고 하면 남는 종류로 다시 불러라. "
                ...
                "properties": {
                    ...
                    "category": {
                        ...
                        "enum": [
                            ...
                            "축제공연행사", "쇼핑", "음식", "한식", "외국식", "간이음식",
                            "주점", "카페", "숙박", "캠핑", "웰니스", "관광지", "여행코스",
                        ],
                    },
